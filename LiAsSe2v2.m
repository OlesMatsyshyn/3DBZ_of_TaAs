...
q = 0.6;
beta = 113.12;
C = [-2.1802808750   0.000000   5.1073980781]*a;
B = [0  5.5419001579  0]*a;
A = [12.2871999741   0  0]*a;
...
for i =mini : maxi
    for j = minj : maxj
        for k =  mink:maxk
           Lip = 0*A+i*A+0.741*B+j*B+1.001*C+k*C;
           Asp = 0.78*A+i*A+0.78*B+j*B+0.33*C+k*C;
           Sep = 0.74*A+i*A+0.78*B+j*B+0.73*C+k*C;
           Se2p =0.98*A+i*A+0.76*B+j*B+0.49*C+k*C; 
